        ...
        with st.spinner("Processing image... Please wait"):
            try:
                ...
                with tempfile.TemporaryDirectory() as temp_dir:
                    ...
                    # Release model resources so it doesn't hold any file handles
                    del model
                    ...
                    if os.path.exists(result_dir):
                        for file in os.listdir(result_dir):
                            if file.lower().endswith(('.png', '.jpg', '.jpeg')):
                                ...
                                # .copy() loads pixel data into memory and releases the
                                # file handle so Windows can delete the temp dir cleanly
                                processed_image = Image.open(result_path).copy()
